...
poly_extent7 = anuga.read_polygon('extent_crop_sw_clip.csv')
poly_extent8 = anuga.read_polygon('extent_s_e_clip.csv')
poly_extent9 = anuga.read_polygon('extent_s_w_clip.csv')
# poly_extent10 = anuga.read_polygon('extent_v_e_clip.csv')
poly_extent11 = anuga.read_polygon('extent_v_w_clip.csv')
