...
#------------------------------------------------------------------------------
domain.set_name('pwrj_SB83_CF_' + project.scenario) # Name of sww file
...
poly_fun_pairs = [[project.bounding_polygon, 0.000],
					...
					[project.poly_extent_add1, 0.031],
					[project.poly_extent_add2, 0.031],
					[project.poly_extent_add3, 0.030],
					[project.poly_extent_add4, 0.030]]
...
tmsfile = 'tmsfile_SB_CF.txt'
print 'Converting time series file '+tmsfile+' to NetCDF TMS file format'
file_text = path_to_data_dir+tmsfile
anuga.file_conversion.file_conversion.timefile2netcdf(file_text, file_out = 'tmsfile_SB_CF.tms', quantity_names=None,
                                time_as_seconds=True)
TS_file = 'tmsfile_SB_CF.tms'
