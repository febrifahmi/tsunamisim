...
#------------------------------------------------------------------------------
domain.set_name('pwrj_SD_CF_' + project.scenario) # Name of sww file
...
tmsfile = 'tmsfile_SD_CF.txt'
print 'Converting time series file '+tmsfile+' to NetCDF TMS file format'
file_text = path_to_data_dir+tmsfile
anuga.file_conversion.file_conversion.timefile2netcdf(file_text, file_out='tmsfile_SD_CF.tms', quantity_names=None,
